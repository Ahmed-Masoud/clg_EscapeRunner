...
namespace LevelBuilder
{
    public class CodesGenerator
    {
        ...
        {   // generate C# codes
            StringWriter code = new StringWriter();
            StringWriter CodeFile = new StringWriter();
            code.Write("// This C# code is generated by LV Map Editor \r\n\r\n");
            ...
            fileName = Path.Combine(fileName, Path.Combine("EscapeRunner", Path.Combine("Res", "Level"))) + "\\";
            fileName += map_name + "-cs.txt";

            StreamWriter file = new StreamWriter(fileName);
            file.WriteLine(CodeFile.ToString());
